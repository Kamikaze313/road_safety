...
class _NavigatePageState extends State<NavigatePage> {
  ...
  Future<LatLng?> getCoordinatesFromPlaceName(String placeName) async {
    ...
    final apiUrl =
        'https://geocode.maps.co/search?q=$placeName&api_key=$apiKey';
    ...
    if (placeName.isNotEmpty) {
      ...
      if (endCord != null) {
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                MapScreen(startCord: startCord, endCord: endCord),
          ),
        );
      } else {
        showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              title: Text('Error'),
              content:
                  Text('Failed to find coordinates for the specified place.'),
              actions: [
                TextButton(
                  onPressed: () {
